...
{
    if (ptr == HPM_SPI7) {
        HPM_IOC->PAD[IOC_PAD_PF25].FUNC_CTL = IOC_PF27_FUNC_CTL_GPIO_F_27;
        HPM_IOC->PAD[IOC_PAD_PF26].FUNC_CTL = IOC_PF26_FUNC_CTL_SPI7_SCLK | IOC_PAD_FUNC_CTL_LOOP_BACK_SET(1);
        HPM_IOC->PAD[IOC_PAD_PF28].FUNC_CTL = IOC_PF28_FUNC_CTL_SPI7_MISO;
        HPM_IOC->PAD[IOC_PAD_PF29].FUNC_CTL = IOC_PF29_FUNC_CTL_SPI7_MOSI;
...
void init_esc_pins(void)
{
    ...
    HPM_IOC->PAD[IOC_PAD_PV14].FUNC_CTL  = IOC_PV15_FUNC_CTL_ESC0_P0_RXER;
    ...
    HPM_IOC->PAD[IOC_PAD_PA28].FUNC_CTL = IOC_PA28_FUNC_CTL_ESC0_CTR_1; /* NMII_LINK0(PORTA_LINK) function */ /* PHY0 LED1 */
    ...
    HPM_IOC->PAD[IOC_PAD_PA25].FUNC_CTL = IOC_PA25_FUNC_CTL_ESC0_CTR_0; /* NMII_LINK1(PORTB_LINK) function */ /* PHY1 LED1 */
    HPM_IOC->PAD[IOC_PAD_PA26].FUNC_CTL = IOC_PAD_FUNC_CTL_ANALOG_MASK; /* PHY1 LED0 */

    HPM_IOC->PAD[IOC_PAD_PC17].FUNC_CTL = IOC_PC17_FUNC_CTL_GPIO_C_17;  //RUN LED
    HPM_IOC->PAD[IOC_PAD_PC18].FUNC_CTL = IOC_PC18_FUNC_CTL_GPIO_C_18;  //ERR LED 
    HPM_GPIO0->OE[GPIO_DI_GPIOC].SET = 1 << 17;
    HPM_GPIO0->OE[GPIO_DI_GPIOC].SET = 1 << 18;

    HPM_IOC->PAD[IOC_PAD_PW12].FUNC_CTL = IOC_PW12_FUNC_CTL_GPIO_W_12;  /* GPIO to reset PHY */
    HPM_IOC->PAD[IOC_PAD_PV12].FUNC_CTL = IOC_PV12_FUNC_CTL_GPIO_V_12;  /* GPIO to reset PHY */
